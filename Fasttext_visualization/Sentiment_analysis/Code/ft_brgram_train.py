...
np.savetxt('x_train_nft.txt', x_train)
np.savetxt('y_train_nft.txt', y_train)
np.savetxt('x_test_nft.txt', x_test)
np.savetxt('y_test_nft.txt', y_test)
...
with open("ft_bigram.json", "w") as json_file:
    json_file.write(model_json)
model.save_weights("ft_bigram.hdf5")
